        ...
        <form action="Loan" method="get">
          <div class="main">
            <div class="form-left-w3l">
              <input type="text" class="top-up" name="name" placeholder="First Name" required="">
            </div>
            <div class="form-right-w3ls ">
              <input type="text" class="top-up" name="last" placeholder="Last Name" required="">
          ...
          <div class="main">
            ...
            <div class="form-right-w3ls ">
              <input type="text" name="did" placeholder="Document Id Type" required="">	
              <div class="clearfix"></div>
            </div>
          </div>
          <div class="main">
            <div class="form-left-w3l">	
              <input type="text" name="dno" placeholder="Document Number" required="">
            </div>
            <div class="form-right-w3ls">
           ...
           <div class="main">
            <div class="form-left-w3l">
              <input type="text" class="top-up" name="w1name" placeholder="Witness 1 Name" required="">
            </div>
            <div class="form-right-w3ls ">
              <input type="text" class="top-up" name="w1no" placeholder="Witness 1 Account  Number" required="">
              <div class="clearfix"></div>
            </div>
          </div>
          <div class="form-control-w3l">
            <textarea name="w1A" placeholder="Witness 1 Address"></textarea>
          </div>
           <div class="form-left-w3l">
              <input type="text" class="top-up" name="w2name" placeholder="Witness 2 Name" required="">
            </div>
            <div class="form-right-w3ls ">
              <input type="text" class="top-up" name="w2no" placeholder="Witness 2 Account  Number" required="">
              <div class="clearfix"></div>
            </div>
          </div>
          <div class="form-control-w3l">
            <textarea name="w2A" placeholder="Witness 2 Address"></textarea>
          </div>
          <div class="btnn">
