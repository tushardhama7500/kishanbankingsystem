        ...
        <form action="Register" method="get">
          <div class="main">
            <div class="form-left-w3l">
              <input type="text" class="top-up" name="fname" placeholder="First Name" required="">
            </div>
            <div class="form-right-w3ls ">
              <input type="text" class="top-up" name="mname" placeholder="Middle Name" >
          ...
          <div class="main">
            ...
            <div class="form-left-w3l">
              <input type="text" name="aadhaar" placeholder="Adhaar Number" required="">	
              <div class="clearfix"></div>
            </div>
          </div>
          <div class="main">
