  ...
  background-color: #dddddd;
	...
	response.sendRedirect("login.jsp");
        ...
        try{
             ...
             Connection con=(Connection)DriverManager.getConnection(
                 "jdbc:mysql://localhost:3306/bank","root","arpit945@@");
        	PreparedStatement st1= con.prepareStatement("select * from transaction where Account_Number=?");
            st1.setLong(1,(long)session.getAttribute("Anumber"));
            ...
            %>
                ...
                <thead>
                    <tr>
                       ...
                       <th style="color:black">Credit/Debit</th>
                ...
                <tbody>
                  ...
                  while(rs1.next())
                  {
                   %>
                      <tr>
                          <td style="color:Red"><%=rs1.getString("SANumber") %></td>
                          <td style="color:red"><%=rs1.getString("Trans_Number") %></td>
                          <td style="color:black"><%=rs1.getString("Amount") %></td>
                          	<td style="color:black"><%=rs1.getString("Date") %></td>
                          <td style="color:black"><%=rs1.getString("Credit") %></td>
                          <td style="color:black"><%=rs1.getString("Balance") %></td>
