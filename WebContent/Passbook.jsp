...
<li class="dropdown"><a href="#" ><%="Welcome "+session.getAttribute("fName") %><b class="caret"></b></a>
 ...
 <div style="padding:10px ;margin:100px;margin-left:400px; border-radius:25px;background-color:white; opacity:0.7;width:50%">
<form action ="PDisplay.jsp">
<br>
<center>
<h2 style="font-size:50px;color:Red">PassBook</h2><br><br>

 <b style="font-size:20px;color:Red">Transactions From:</b>
  <input type="date" name="from" required><br><br><br><br>
   <big><big><big><b style="font-size:20px;color:Red">Transactions Till:</b></big></big></big>
  <input type="date" name="to" required><br><br><br><br>
  
  <input type="submit" style="font-size:20px;color:Red" >
  </center>
 </div>
