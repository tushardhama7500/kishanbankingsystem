...
<html lang="en" class="no-js">
	...
	<body style="background-image: url('images/b1.jpg');">
	  <div id="st-container" class="st-container">
        ...
        PreparedStatement st= con.prepareStatement("select * from register where Account_Number=?");
         ...
         %>
           ...
           <p style="color: black; font-size: 25px; font-style: solid;margin-left:30px" ><b> ACCOUNT NUMBER : </b> <%=rs.getString("Account_Number") %><br></p>
               ...
               <% if(rs.getString("Middle_Name")!=null)
                		{%>
                <p style="color: black; font-size: 25px; font-style: solid;margin-left:30px" > <b>MIDDLE NAME : </b>
                		
                		<%=
                				rs.getString("Middle_Name") %><br><%}%></p>
              ...
              <p style="color: black; font-size: 25px; font-style: solid;margin-left:30px"><b> DATE OF BIRTH:</b> <%=rs.getString("DOB") %> <br></p>
              <p style="color: black; font-size: 25px; font-style: solid;margin-left:30px"><b> ACCOUNT TYPE:</b> <%=rs.getString("Acc_Type")+" Account" %> <br></p>
              <p style="color: black; font-size: 25px; font-style: solid;margin-left:30px"><b> ADHAAR NUMBER: </b><%=rs.getString("Adhaar_Number") %> <br></p>
              <p style="color: black; font-size: 25px; font-style: solid;margin-left:30px"><b> ADDRESS: </b><%=rs.getString("Address") %> <br></p>
              <p style="color: black; font-size: 25px; font-style: solid;margin-left:30px"> <b>PHONE NUMBER: </b><%=rs.getString("Phone_Number") %> <br></p>
             
              <p style="color: black; font-size: 25px; font-style: solid;margin-left:30px"> <b>BALANCE:</b> <style="color:red"><%=rs.getString("Balance")%></style><br></p>
              <br>
              <br>
              <%session.setAttribute("temp", "yes"); %>
              <%session.setAttribute("status", rs.getInt("Status")); %>
               <button style="border-radius:25px;font-size:20px; font-style: solid; color: Red; background-color: white" onclick="location.href='Transaction.jsp'"><b>Last 10 Transactions</b></button>
              <%}
              else if(rs.getInt("Status")==0)
              { session.setAttribute("temp", "no"); 
              %>
              <p style="color: Red; font-size: 30px; font-style: solid;"> STATUS: <h3 style="color:red">UnRegistered<br>
              Please Wait Until Your Documents are being Verified.</h3><br></p>
             
               <%}else{
            	   session.setAttribute("temp", "no"); 
            	   %>
            	   <p style="color: Red; font-size: 30px; font-style: solid;"> STATUS: Sorry You Are Not Eligible for Bank Account!!!</p><br></p>
            	   <%
            	   } 
